...
add_action('template_redirect', function() {
    ...
    if ($slug === 'modifica-stallone') {
        include AM_PLUGIN_DIR . 'includes/dashboard/modifica-stallone.php';
        exit; // blocca il rendering della dashboard classica
    }
	
    if ($slug === 'modifica-fattrice') {
        include AM_PLUGIN_DIR . 'includes/dashboard/modifica-fattrice.php';
        exit; // blocca il rendering della dashboard classica
    }
});
